...
CSLegend = ax.legend(loc='lower right', bbox_to_anchor=(1,0), ncol=2, fontsize=12)
...
ax.legend(handles=ExpUrdLegend, loc='lower right', bbox_to_anchor=(1,0.53), ncol=2, fontsize=12)
ax.set_xlabel('Temperature (K)')
ax.set_ylabel('Ion Fraction')
